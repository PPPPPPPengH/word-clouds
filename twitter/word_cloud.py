...
def create_wordcloud(lan,text,name,initial_month,initial_year,final_month,final_year):
    ...
    name = re.sub(" ","-",name)
    png_path = f"output/wordclouds/{name}_{lan}_{initial_month}-{initial_year}_{final_month}-{final_year}.png"
